    ...
    <div className="min-h-screen mt-16 bg-gradient-to-br from-slate-900 via-emerald-950 to-teal-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          <Link
            href="/"
            className="inline-flex items-center text-emerald-400 hover:text-emerald-300 mb-4 transition-colors group"
          >
        ...
        >
          « Sois courageux et agis de telle sorte que les gens croient que tu ne manques de rien » — Serigne Touba (QSS)
        </motion.p>
      </div>
    </div>
  );
